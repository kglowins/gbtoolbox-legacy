...
//	private JMenuItem itemHelp;
    ...
    private class ModuleListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            switch (s) {
                case INDIV:
                    indivToolbarBtn.requestFocus();
                    break;
                case CATALOG_ANA:
                    catAnaToolbarBtn.requestFocus();
                    break;
                case CATALOG_NUM:
                    catNumToolbarBtn.requestFocus();
                    break;
                case SUBSETS:
                    subsetsBtn.requestFocus();
                    break;
                case RANDOM:
                    randToolbarBtn.requestFocus();
                    break;
                case IMPORT:
                    importToolbarBtn.requestFocus();
                    break;
                case REPROC:
                    reprocBtn.requestFocus();
                    break;
                case STATS:
                    statToolbarBtn.requestFocus();
                    break;
                case NORM:
                    normToolbarBtn.requestFocus();
                    break;
                case GBCD_GBPD_PREVIEW:
                    previewToolbarBtn.requestFocus();
                    break;
                case HEX2SQ:
                    mainPanel.requestFocus();
                    break;
