...
import com.github.kglowins.gbtoolbox.gui_bricks.MisorPanel;
import com.github.kglowins.gbtoolbox.gui_modules.DrawSelectedGBsPanel;
...
import com.github.kglowins.gbtoolbox.utils.Quaternion;
...
public class Dialog_GBPlusLimitsForDraw extends JFrame {
	...
	public Dialog_GBPlusLimitsForDraw(PointGroup pointGrp, final DrawSelectedGBsPanel subsetsPanel) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Dialog_GBPlusLimitsForDraw.class.getResource("/gui_bricks/gbtoolbox.png")));
		...
		maxFld.addFocusListener(new FocusListener() {
			...
			public void focusLost(FocusEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(Dialog_GBPlusLimitsForDraw.this,
		...
		predefMisBtn.setIcon(new ImageIcon(Dialog_GBPlusLimitsForDraw.class.getResource("/gui_bricks/sum-icon.png")));
		...
		lblNewLabel = new JLabel("<html><font color=#0000bb><small>If you want to use an arbitrary misorientation (plane), then just do not fill in the corresponding fields.</small></font>");
		contentPane.add(lblNewLabel, "cell 0 16 2 1,alignx center,gapy 10 10");
		
		addBtn = new JButton("Add");
		addBtn.setIcon(new ImageIcon(Dialog_GBPlusLimitsForDraw.class.getResource("/gui_bricks/add-icon.png")));
		contentPane.add(addBtn, "flowx,cell 0 17 2 1,alignx center");
		
		cancelBtn = new JButton("Cancel");
		cancelBtn.setIcon(new ImageIcon(Dialog_GBPlusLimitsForDraw.class.getResource("/gui_bricks/abort.png")));
						...
						if(dist < 1e-4d && Math.abs(Mfix.det() - 1d) < 1e-3d) {
							...
							if(Mfix.det() > 0d) {
								int answer = JOptionPane.showConfirmDialog(
										Dialog_GBPlusLimitsForDraw.this,
